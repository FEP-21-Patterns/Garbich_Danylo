...
string deviceId = "SMART_SPEAKER-" + Guid.NewGuid().ToString("N").Substring(0, 8);
string deviceName = "Smart Speaker";
bool connected = false;
double temperature = 21.5;

app.MapGet("/", () => Results.Ok(new { Id = deviceId, Name = deviceName, Host = "localhost", Port = 5001 }));
app.MapPost("/connect", () => {
    connected = true;
...
app.MapGet("/status", () => {
    var status = connected ? "speaker_on" : "speaker_off";
